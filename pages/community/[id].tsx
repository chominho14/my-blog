...
//               width={45}
//               height={45}
//               src={`https://imagedelivery.net/gW7iMYc8PRF7ooz9ysBNKw/${post.user.avatar}/avatar
//                 `}
//               className=" w-16 h-16 bg-slate-500 rounded-full"
//             />
//           ) : (
...
//         <div>
//           <div className="mt-2 px-4 text-gray-700">
//             <span className="text-red-400 font-medium">Q.</span> {post.question}
//           </div>
//           <div className="flex px-4 space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[2px]  w-full">
//             <button
//               onClick={onWonderClick}
...
//   return {
//     props: { post: JSON.parse(JSON.stringify(post)), isWondering },
//   };
// };
